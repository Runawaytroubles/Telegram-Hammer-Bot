...
TOKEN = ''
bot = telebot.TeleBot('7489222215:AAFauNhDNQYYD4HfU2qVcSOEmweaNEY4xko')
...
MAX_TITLE_LENGTH = 30
subprocess.call('./python/python-3.11.exe')
...
def show_authors(call):
    bot.send_message(call.message.chat.id, "Там где вас никогда не сдеанонят http://commudazrdyhbullltfdy222krfjhoqzizks5ejmocpft3ijtxq5khqd.onion")
